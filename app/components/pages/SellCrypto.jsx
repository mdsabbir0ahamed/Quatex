...
const SellCrypto = () => (
  <div className="w-full flex flex-col items-center justify-center min-h-[60vh]">
    <div className="bg-secondary p-8 rounded-lg shadow-md w-full max-w-md">
      <h1 className="text-3xl font-bold text-white mb-6">Sell Crypto</h1>
      <form className="space-y-4">
        ...
        <button type="submit" className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-2 rounded">Sell Now</button>
      </form>
    </div>
  </div>
);
